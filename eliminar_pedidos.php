...
<?php
 if (isset($_POST['eliminar_cliente'])) {
                    ...
                    $eliminarped =  "DELETE FROM pedidos WHERE id_user = '$id_pedido'";
                    $consultaeliminar = mysqli_query($conexion,$eliminarped);

                 
                    echo "SE ELIMINO EL PEDIDO <br>";
                    echo "<a href='pedidos.php'>VOLVER A PEDIDOS </a><br>";
                  
 }
 
?>

 	DESEA ELIMINAR EL PEDIDO<br><br>
 	<div class='btn-group'>
 	<form method="post">
